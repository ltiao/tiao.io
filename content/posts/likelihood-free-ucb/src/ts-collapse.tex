...
\addplot[domain=0.02:0.98, samples=220, thick, densely dashdotted, black!80] {mmu(x) + 0.8416*ssg(x)};
\addlegendentry{$\mu + \sqrt{\beta_{\mathrm{eff}}}\sigma$,\ $\beta_{\mathrm{eff}} = \Phi^{-1}(0.8)^2 \approx 0.71$}
