...
&\approx \frac{1}{M} \sum_{m=1}^M p(u | \omega^{(m)}),
\qquad
...
$$
p(y_n | f(\mathbf{x}_n)) = \sigma(y_n f(\mathbf{x}_n))
$$
...
$$
p(y_n, \omega_n | f(\mathbf{x}_n)) = p(y_n | \omega_n, f(\mathbf{x}_n)) p(\omega_n)
$$

$$
p(y_n | \omega_n, f(\mathbf{x}_n)) = 
\frac{1}{2} 
\exp{ \left (\frac{y_n f(\mathbf{x}_n)}{2} - 
\frac{f(\mathbf{x}_n)^2}{2} \omega_n \right )}, 
\qquad 
\text{and}
\qquad 
...
\begin{align}
p(y_n | f(\mathbf{x}_n)) &=
\int p(y_n, \omega_n | f(\mathbf{x}_n)) d\omega_n \newline 
&= \int p(y_n | \omega_n, f(\mathbf{x}_n)) p(\omega_n) d\omega_n \newline 
&= \frac{1}{2} \int \exp{ \left (\frac{y_n f(\mathbf{x}_n)}{2} - 
\frac{f(\mathbf{x}_n)^2}{2} \omega_n \right )} \mathrm{PG}(\omega_n | 1, 0) d\omega_n \newline
&= \sigma(y_n f(\mathbf{x}_n))
\end{align}
$$
