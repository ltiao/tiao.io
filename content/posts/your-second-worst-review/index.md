...
![ROC curves for logistic regression on each individual score, the mean, and all four scores together. The second-lowest score dominates the lowest; the mean and all-four curves sit above both.](roc-curves.png)
